...
Examples:
YES: "Media bias is the systematic deviation of news coverage in favor of certain actors."
YES: "Algorithmic fairness involves ensuring that automated decisions do not systematically disadvantage protected groups based on sensitive attributes."
NO: "We use logistic regression to predict outcomes."
NO: "See Johnson (2020) for a definition of X."
NO: "Examples include machine learning, deep learning, and AI."
...
class MultiStepFewShotExtractor(BaseExtractor):
    def __init__(
        self,
        llm_client,
